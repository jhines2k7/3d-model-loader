package com.hines.james.camera.matrix;

import com.hines.james.math.Vector3f;
import com.hines.james.camera.Camera;
import com.hines.james.util.Utilities;

import java.nio.FloatBuffer;

public class CameraMatrix4f {

    public static final int SIZE = 4 * 4;
    public float[] elements = new float[SIZE];

    public CameraMatrix4f(){ }

    public static CameraMatrix4f identity(){
        // Initialize a new matrix
        CameraMatrix4f matrix = new CameraMatrix4f();
    ...
    public static CameraMatrix4f perspective(float left, float right, float bottom, float top, float near, float far, float FoV, float aspect){
    ...
    public static CameraMatrix4f frustrum(float left, float right, float bottom, float top, float near, float far){
        CameraMatrix4f cameraMat = new CameraMatrix4f();
    ...
    public static CameraMatrix4f setupViewMatrix(Camera camera){
    ...
    public static CameraMatrix4f orthographic(float left, float right, float bottom, float top, float near, float far){
        CameraMatrix4f matrix = new CameraMatrix4f();
    ...
    public static CameraMatrix4f translate(Vector3f vector){
        CameraMatrix4f matrix = identity();
    ...
    public static CameraMatrix4f rotateZ(float angle){
        CameraMatrix4f matrix = identity();
    ...
    public static CameraMatrix4f rotateY(float angle){
        CameraMatrix4f matrix = identity();
        float r = (float) Math.toRadians(angle);
        float cos = (float) Math.cos(r);
        float sin = (float) Math.sin(r);
    ...
    public static CameraMatrix4f rotateX(float angle){
        CameraMatrix4f matrix = identity();
        float r = (float) Math.toRadians(angle);
        float cos = (float) Math.cos(r);
        float sin = (float) Math.sin(r);
    ...
    // how it works first.
    public CameraMatrix4f multiply(CameraMatrix4f matrix){
        CameraMatrix4f result = new CameraMatrix4f();
        for(int x = 0; x < 4; x++){
            for(int y = 0; y < 4; y++){
                float sum = 0.0f;
                for(int e = 0; e < 4; e++){
